...
class DeepReadResult(BaseModel):
    ...
    key_contributions: List[str] = Field(default_factory=list, description="3-5 specific contributions")
    methodology_analysis: str = Field("", description="Detailed analysis of methods")
    results_analysis: str = Field("", description="Analysis of key results with specific numbers")
    strengths: List[str] = Field(default_factory=list, description="2-4 specific strengths")
    limitations: List[str] = Field(default_factory=list, description="1-3 limitations or areas for improvement")
    connections_to_research: str = Field("", description="How this connects to researcher's interests")
    overall_assessment: str = Field("", description="Final verdict on significance, novelty, quality")
...
class PaperAnalysis(BaseModel):
    ...
    deep_read: Optional[DeepReadResult] = Field(None, description="Optional deep reading analysis for high-score papers")
