...
SOURCE_DISPLAY_INFO = {
    "arxiv": {"name": "arXiv", "url": "https://arxiv.org/", "icon": "fas fa-archive"},
    "aps": {"name": "APS", "url": "https://journals.aps.org/", "icon": "fas fa-atom"},
    "nature": {
        "name": "Nature",
    ...
    "acm": {"name": "ACM", "url": "https://dl.acm.org/", "icon": "fas fa-laptop-code"},
    "other": {"name": "Other Sources", "url": "#", "icon": "fas fa-rss"},
}
